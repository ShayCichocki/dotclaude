...
theme.syntax = {
  ...
  Constant = { fg = colors.green19 },
  String = { fg = colors.green16 },
  Character = { fg = colors.green16 },
  Number = { fg = colors.green21 },
  Boolean = { fg = colors.green21 },
  Float = { fg = colors.green21 },

  Identifier = { fg = colors.green17 },
  Function = { fg = colors.green23, bold = true },

  Statement = { fg = colors.green19, bold = true },
  Conditional = { fg = colors.green19, bold = true },
  Repeat = { fg = colors.green19, bold = true },
  Label = { fg = colors.green19, bold = true },
  Operator = { fg = colors.green14 },
  Keyword = { fg = colors.green19, bold = true },
  Exception = { fg = colors.orange, bold = true },

  PreProc = { fg = colors.green21 },
  Include = { fg = colors.green21 },
  Define = { fg = colors.green21 },
  Macro = { fg = colors.green21 },
  PreCondit = { fg = colors.green21 },

  Type = { fg = colors.green17, bold = true },
  StorageClass = { fg = colors.green17, bold = true },
  Structure = { fg = colors.green17, bold = true },
  Typedef = { fg = colors.green17, bold = true },

  Special = { fg = colors.green23 },
  SpecialChar = { fg = colors.cyan },
  Tag = { fg = colors.green19 },
...
theme.treesitter = {
  ...
  ["@variable.builtin"] = { fg = colors.green21, italic = true },
  ["@variable.parameter"] = { fg = colors.green15 },
  ["@variable.member"] = { fg = colors.green16 },

  ["@constant"] = { fg = colors.green19 },
  ["@constant.builtin"] = { fg = colors.green21 },
  ["@constant.macro"] = { fg = colors.green21 },
  ...
  ["@function"] = { fg = colors.green23, bold = true },
  ["@function.builtin"] = { fg = colors.green21, bold = true },
  ["@function.macro"] = { fg = colors.green21 },
  ["@function.method"] = { fg = colors.green23, bold = true },

  ["@constructor"] = { fg = colors.green19 },
  ["@operator"] = { fg = colors.green14 },

  ["@keyword"] = { fg = colors.green19, bold = true },
  ["@keyword.function"] = { fg = colors.green19, bold = true },
  ["@keyword.return"] = { fg = colors.green19, bold = true },
  ["@keyword.operator"] = { fg = colors.green19 },
  ...
  ["@type"] = { fg = colors.green17, bold = true },
  ["@type.builtin"] = { fg = colors.green17, italic = true },
  ["@type.qualifier"] = { fg = colors.green19 },

  ["@property"] = { fg = colors.green16 },
  ["@field"] = { fg = colors.green16 },

  ["@punctuation.delimiter"] = { fg = colors.green11 },
  ["@punctuation.bracket"] = { fg = colors.green14 },
  ["@punctuation.special"] = { fg = colors.green17 },
